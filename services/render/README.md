...
declares just this service, routes all project traffic to it, and skips
deployments when none of those inputs changed. Web-only preview commits
therefore do not create container images.
